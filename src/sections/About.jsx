      ...
      <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
        <div className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            ...
            <div>
              <p className="grid-headtext">Hi, I&apos;m Name</p>
              <p className="grid-subtext">
                With x Years of experience, I have honed my skills in frontend 
          ...
          <div className="grid-container">
            <div className="rounded-3xl w-full sm:h-[326px] h-fit flex justify-center items-center">
              <Globe 
                ...
                labelsData={[{ lat: 40, lng: -8.5, text: "I'm here!", color: 'white', size: 15 }]}
              />
            </div>
          ...
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                ...
                It isnt just my profession - it is my passion
              </p>
            </div>
          </div>
        </div>
